...
class _HomeViewState extends State<HomeView> {
  ...
  late Future<List<PatientRequest>> _requestsFuture;

  @override
  void initState() {
    super.initState();
    // Cache the requests future to avoid re-firing on every build
    _requestsFuture = _requestsController.fetchPatientRequests();
    // Proactively fetch/verify patient profile data on startup
  ...
  Future<void> _handleRefresh() async {
    ...
    // Trigger reloading of profile data
